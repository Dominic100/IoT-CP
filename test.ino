...
const char *GScriptId = "AKfycbzF3NciNxcdl2pJPZV281Xb7WG2kpgXrM1MOqnj6-X8m2GGywprmvdVNjoGg-neFL0clA";
...
void loop() {
  ...
  if (digitalRead(buttonPin) == HIGH) {
    // Button is pressed, increment the button press count
    buttonPressCount++;
    Serial.println("Incremented by 1");
  }
  ...
  values += String(buttonPressCount) + ",";
  values += gate_number + "\"}";
  //----------------------------------------------------------------
